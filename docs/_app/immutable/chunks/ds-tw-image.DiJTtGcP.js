var d=Object.defineProperty;var h=(s,t,o)=>t in s?d(s,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):s[t]=o;var r=(s,t,o)=>h(s,typeof t!="symbol"?t+"":t,o);import{a as i,s as l,T as n,x as e,i as g}from"./class-map.CUp2aMEF.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const a=s=>s??i;class c extends l{constructor(){super();r(this,"svgIcons",{warning:e` <svg
    ...
    >
      ...
      />
    </svg>`});this.variant="",this.showFooter=!1,this.text="Open",this.showText=!1,this.submitButtonLabel="Submit",this.cancelButtonLabel="Cancel",this.icon="warning",this.handleEvent=this.handleEvent.bind(this),this.hideButton=!1,this.showModal=!1,window.addEventListener("ds-event",this.handleEvent)}static get styles(){return[n]}static get properties(){return{variant:{type:String},icon:{type:String},text:{type:String},showText:{type:Boolean},submitButtonLabel:{type:String},cancelButtonLabel:{type:String},showFooter:{type:Boolean},showModal:{type:Boolean},hideButton:{type:Boolean}}}toggleModalWindow(){this.shadowRoot.querySelector("div[role=dialog]").classList.toggle("hidden")}handleEvent(o){o.detail.eventName==="toggle-modal"&&this.toggleModalWindow()}handleSubmit(){this.toggleModalWindow()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("ds-event",this.handleEvent)}modalTriggerButton(){return this.showText?e` <span class="cursor-pointer" @click=${this.toggleModalWindow}>
          ${this.text}
        </span>`:e` <button
        ...
        >
          ${this.text}
        </button>`}renderFooter(){if(this.showFooter){if(this.variant==="primary")return e` <div
      ...
      </div>`;if(this.variant==="secondary")return e` <div
      ...
      >
      ...
      </div>`}}firstUpdated(){this.showModal&&this.toggleModalWindow()}render(){if(this.variant==="primary")return e` <div class="contents">
        ...
        >
          ...
          >
            <!-- Modal content -->
            <div
              class="relative max-w-4xl rounded-lg bg-white shadow dark:bg-gray-700"
            >
              <!-- Modal header -->
              <div
      ...
      </div>`;if(this.variant="secondary")return e`
        ${this.hideButton?i:this.modalTriggerButton()}
        <div
          class="z-10 hidden"
      ...
      `}}customElements.define("ds-tw-modal",c);class u extends l{static get styles(){return[n,g`
        img {
          cursor: pointer;
        }
        .modal {

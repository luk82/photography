var H=Object.defineProperty;var D=(n,s,e)=>s in n?H(n,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[s]=e;var j=(n,s,e)=>D(n,typeof s!="symbol"?s+"":s,e);import{d as N}from"../chunks/index.R8ovVqwX.js";import{s as G,n as E}from"../chunks/scheduler.Bmg8oFKD.js";import{S as O,i as U,e as c,s as k,k as V,c as g,d,f as C,l as z,a as F,m as _,n as h,h as u,g as M}from"../chunks/index.4GapGig5.js";import{s as W,T as R,i as Y,x as r,e as S,r as J,b as K,a as Q}from"../chunks/class-map.CUp2aMEF.js";import"../chunks/ds-tw-band.Dl42OW0z.js";import"../chunks/ds-tw-feature.Dilw8LVj.js";const X=N,Z=!0,me=Object.freeze(Object.defineProperty({__proto__:null,csr:X,prerender:Z},Symbol.toStringTag,{value:"Module"}));class ee extends W{constructor(){super();j(this,"svgIcons",{check:r`<svg
    ...
    >
      ...
      >
        <path
          d="M 42.981 61.73 c -0.028 0 -0.056 0 -0.084 -0.001 c -0.825 -0.023 -1.604 -0.385 -2.153 -1 l -16.962 -18.98 c -1.104 -1.235 -0.998 -3.132 0.238 -4.236 c 1.235 -1.105 3.131 -0.998 4.236 0.238 l 14.848 16.614 L 84.879 12.59 c 1.172 -1.172 3.07 -1.172 4.242 0 c 1.172 1.171 1.172 3.071 0 4.242 L 45.102 60.852 C 44.539 61.415 43.775 61.73 42.981 61.73 z"
          style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1;"
          transform=" matrix(1 0 0 1 0 0) "
          stroke-linecap="round"
        />
        <path
          d="M 45 90 C 20.187 90 0 69.813 0 45 C 0 20.187 20.187 0 45 0 c 1.657 0 3 1.343 3 3 s -1.343 3 -3 3 C 23.495 6 6 23.495 6 45 s 17.495 39 39 39 s 39 -17.495 39 -39 c 0 -1.657 1.343 -3 3 -3 s 3 1.343 3 3 C 90 69.813 69.813 90 45 90 z"
          style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1;"
          transform=" matrix(1 0 0 1 0 0) "
          stroke-linecap="round"
        />
    ...
    >
      ...
      >
        <path
          ...
          style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(206,52,52); fill-rule: nonzero; opacity: 1;"
          transform=" matrix(1 0 0 1 0 0) "
          stroke-linecap="round"
        />
        <rect
    ...
    </svg>`});this.variant="primary",this.hasRoundedCorners=!1,this.skew="none",this._yearly=!1,this._monthly=!0,this.savings=10}static get styles(){return[R,Y`
        :host {
        ...
        <div class="bg-[var(--pricing-bg)] py-20">
          <div class="container mx-auto px-4">
            ...
            <div class="-mx-4 flex flex-wrap">
              <div class="mb-8 w-full px-4 md:w-1/2 lg:mb-0 lg:w-1/3">
                <div class="rounded bg-white p-8 shadow">
                  <h4 class="font-heading mb-2 text-2xl font-bold">Beginner</h4>
                  <span class="text-6xl font-bold">Free</span>
                  <p class="mb-6 mt-3 leading-loose text-gray-500">
                  ...
                  <ul class="mb-6 text-gray-500">
                    <li class="mb-2 flex">
                      <svg
                        class="mr-2 h-5 w-5 text-[var(--pricing-primary)]"
                        xmlns="http://www.w3.org/2000/svg"
                        viewbox="0 0 20 20"
                        fill="currentColor"
                      >
                  ...
                  <a
                    class="inline-block w-full rounded-l-xl rounded-t-xl bg-[var(--pricing-theme)] px-4 py-2 text-center font-bold leading-loose text-white transition duration-200 hover:bg-[var(--pricing-primary)]"
                    href="#"
                    >Get Started</a
                  >
                </div>
              ...
              <div class="mb-8 w-full px-4 md:w-1/2 lg:mb-0 lg:w-1/3">
                <div class="rounded bg-[var(--pricing-theme)] p-8 shadow">
                  <h4 class="mb-2 text-2xl font-bold text-white">
                    Intermediate
                  </h4>
                  <span class="text-6xl font-bold text-white">$24</span>
                  <span class="text-xs text-gray-50">/month</span>
                  <p class="mb-6 mt-3 leading-loose text-gray-50">
                    Nullam diam arcu, sodales quis convallis sit amet, sagittis
                    varius ligula.
                  </p>
                  <ul class="mb-6 text-gray-50">
                    <li class="mb-2 flex">
                      <svg
                        class="mr-2 h-5 w-5 text-[var(--pricing-secondary)]"
                        xmlns="http://www.w3.org/2000/svg"
                        viewbox="0 0 20 20"
                        fill="currentColor"
                      >
                  ...
                  <a
                    class="inline-block w-full rounded-l-xl rounded-t-xl bg-white px-4 py-2 text-center font-bold leading-loose transition duration-200 hover:bg-gray-50"
                    href="#"
                    >Get Started</a
                  >
                </div>
              ...
              <div class="w-full px-4 lg:w-1/3">
                <div class="rounded bg-white p-8 shadow">
                  <h4 class="font-heading mb-2 text-2xl font-bold">
                    Professional
                  </h4>
      ...
      </section>`}if(this.variant=="primary")return r`<div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-[var(--container-width)] px-6 lg:px-8">
          <div class="mx-auto max-w-2xl sm:text-center">
            <h2
              class="text-3xl font-bold tracking-tight text-[var(--pricing-title)] text-gray-900 sm:text-4xl"
            >
      ...
      </div>`;if(this.variant=="secondary-2")return this.hasRoundedCorners,this.hasRoundedCorners,r` <section
        class="relative overflow-hidden bg-[var(--pricing-bg)] py-20 "
      >
        <div class="container relative mx-auto px-4">
          <div class="mx-auto mb-24 max-w-2xl text-center lg:max-w-5xl">
            <h1
              class="font-heading mb-8 text-4xl font-bold text-gray-900 sm:text-6xl lg:text-7xl"
            >
              <slot name="header">Header here</slot>
              <span class="font-serif italic text-[var(--pricing-theme)]"
                ><slot name="header-bold"></slot
              ></span>
            </h1>
          ...
          <div class="mx-auto max-w-5xl">
            <div class="flex flex-wrap items-center">
              <div class="w-full lg:-mr-2 lg:w-1/3">
                <slot name="membership-1"></slot>
              </div>

              <div class="-mt-4 w-full lg:-mt-0 lg:w-1/3">
                <slot name="membership-2"></slot>
              </div>

              <div class="-mt-4 w-full lg:-ml-2 lg:-mt-0 lg:w-1/3">
                <slot name="membership-3"></slot>
              </div>
            </div>
          </div>
        </div>
      </section>`}render(){return r`${J(this.skew)}${this.renderTemplate()}${K(this.skew)}`}}customElements.define("ds-tw-pricing",ee);class te extends W{constructor(){super();j(this,"svgIcons",{check:r`<svg
      xmlns="http://www.w3.org/2000/svg"
      xmlns:xlink="http://www.w3.org/1999/xlink"
      version="1.1"
      width="18"
    ...
    </div>`}renderPrimaryTemplate(){const e=this.listElements.split(";");return r`
      <div
        class="mx-auto mt-16 max-w-2xl rounded-[var(--membership-border-radius)] ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none"
      >
        <div class="p-8 sm:p-10 lg:flex-auto">
          ...
          <div class="mt-10 flex items-center gap-x-4">
            <h4
              class="flex-none text-sm font-semibold leading-6 text-[var(--membership-theme)]"
            >
          ...
          >
            ${e.map(t=>r`
                <li class="flex gap-x-3">
                  <svg
                    class="h-6 w-5 flex-none text-[var(--membership-primary)] text-indigo-600"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
                  >
              ...
              >
                <div
                  class="h-full rounded-[var(--membership-border-radius)] bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16"
                >
                  <div class="mx-auto max-w-xs px-8">
                    ...
                    <p class="mt-6 flex items-baseline justify-center gap-x-2">
                      ...
                      ></span>
                       ...
                       ${this.hideCta?"":r` <slot name="cta"></slot>`}
      ...
      >
        ...
        <span class="flex items-end">
          <span class="text-4xl font-extrabold leading-none"
            ><slot name="price">£99</slot></span
          >
          <span class="text-sm font-semibold"
            ><slot name="price-footer"> per month </slot></span
          >
        </span>
        <div class="mt-7 border-t border-gray-100 pt-5">
          <ul class="mb-10">
            ${this.renderIncludedExcludedList()}
          </ul>
...
Wedding albums from £199;
Engagement session from £300;
+£100 per extra hour"><span slot="title">Silver</span> <span slot="body"></span> <span slot="list-title">What’s included</span> <span slot="price">£599</span> <span slot="price-footer"></span></ds-tw-membership> <ds-tw-membership hidecta="" listelements="Services included in silver package;
Additional hour extra coverage pre or post service;
Wedding album - 30 pages A4;
One 12x10 framed print;
Engagement session from £300;
+£100 per extra hour"><span slot="title">Gold</span> <span slot="body"></span> <span slot="list-title">What’s included</span> <span slot="price">£899</span></ds-tw-membership> <ds-tw-membership hidecta="" currency="" listelements="Services included in gold package;
Engagement session;
Additional hour of coverage pre or post service;
Additional copy of a wedding album;
+£100 per extra hour"><span slot="title">Platinum</span> <span slot="body"></span> <span slot="list-title">What&#39;s included</span> <span slot="price">£1,299</span> <span slot="price-footer"></span></ds-tw-membership></span>`,L,i,x,I="Capture the Magic Before the Big Day",P,w,A="Discover the Charm and Intimacy of Pre-Wedding Photography Sessions",$,f,B=`<p>Pre-wedding sessions, also known as engagement shoots, offer couples a unique opportunity to
			...
			adventure in the city, we tailor each session to reflect your unique style and love story.</p> <p>During a pre-wedding session, we focus on capturing candid moments and genuine emotions that
			...
			cherish forever, setting the perfect tone for your upcoming nuptials.</p> <div><br/> <ds-tw-button variant="primary-2" link="#" hasarrow=""></ds-tw-button></div>`,T,b,q='<ds-tw-button link="#">Enquire</ds-tw-button>';return{c(){s=c("meta"),e=k(),t=c("ds-tw-band"),t.innerHTML=v,p=k(),a=c("ds-tw-pricing"),a.innerHTML=y,L=k(),i=c("ds-tw-feature"),x=c("span"),x.textContent=I,P=k(),w=c("span"),w.textContent=A,$=k(),f=c("span"),f.innerHTML=B,T=k(),b=c("span"),b.innerHTML=q,this.h()},l(l){const o=V("svelte-taey3e",document.head);s=g(o,"META",{name:!0,content:!0}),o.forEach(d),e=C(l),t=g(l,"DS-TW-BAND",{variant:!0,height:!0,"to-center":!0,bgImage:!0,skew:!0,"data-svelte-h":!0}),z(t)!=="svelte-1k7lkvq"&&(t.innerHTML=v),p=C(l),a=g(l,"DS-TW-PRICING",{variant:!0,"data-svelte-h":!0}),z(a)!=="svelte-x508hw"&&(a.innerHTML=y),L=C(l),i=g(l,"DS-TW-FEATURE",{image:!0,variant:!0});var m=F(i);x=g(m,"SPAN",{slot:!0,"data-svelte-h":!0}),z(x)!=="svelte-142fe64"&&(x.textContent=I),P=C(m),w=g(m,"SPAN",{slot:!0,"data-svelte-h":!0}),z(w)!=="svelte-xvs0zd"&&(w.textContent=A),$=C(m),f=g(m,"SPAN",{slot:!0,"data-svelte-h":!0}),z(f)!=="svelte-x1z8h8"&&(f.innerHTML=B),T=C(m),b=g(m,"SPAN",{slot:!0,"data-svelte-h":!0}),z(b)!=="svelte-1odsdub"&&(b.innerHTML=q),m.forEach(d),this.h()},h(){document.title="Pricing",_(s,"name","description"),_(s,"content","Wedding Photogrraphy"),h(t,"variant","primary"),h(t,"height","450"),h(t,"to-center",""),h(t,"bgImage","images/slider-1.jpg"),h(t,"skew",""),h(a,"variant","primary"),_(x,"slot","kicker"),_(w,"slot","header"),_(f,"slot","body"),_(b,"slot","buttons"),h(i,"image",n[0]),h(i,"variant","primary")},m(l,o){u(document.head,s),M(l,e,o),M(l,t,o),M(l,p,o),M(l,a,o),M(l,L,o),M(l,i,o),u(i,x),u(i,P),u(i,w),u(i,$),u(i,f),u(i,T),u(i,b)},p:E,i:E,o:E,d(l){l&&(d(e),d(t),d(p),d(a),d(L),d(i)),d(s)}}}function re(n){return[["images/wedding-photography-corby.jpg","images/image.jpg","images/pre-wedding-session.jpg"]]}class ce extends O{constructor(s){super(),U(this,s,re,se,G,{})}}export{ce as component,me as universal};
